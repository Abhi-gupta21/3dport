    ...
    const handleNavigation = (direction) => {
        setSelectedProjectIndex((prevIndex) => {
            if (direction === "previous") {
                return prevIndex > 0 ? prevIndex - 1 : myProjects.length - 1;
            } else {
                return prevIndex < myProjects.length - 1 ? prevIndex + 1 : 0;
            }
        });
    };

    if (!currProject) return <div>No projects available</div>;
            ...
            <div className="grid lg:grid-cols-2 grid-cols-1 mt-12 gap-5 w-full">
                <div className="flex flex-col gap-5 sm:p-10 py-10 px-5 shadow-2xl shadow-black-200 relative">
                    ...
                    <div className="flex items-center justify-between flex-wrap gap-5">
                        ...
                        <a className="flex items-center gap-2 cursor-pointer text-white" href={currProject.href} target="_blank" rel="noopener noreferrer">
                            <p>Check Live Demo</p>
